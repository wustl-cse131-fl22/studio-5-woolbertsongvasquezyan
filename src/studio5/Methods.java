...
public class Methods {
	...
	/**
	 * Return the average of integers within an array
	 * 
	 * @param array the integer array which is being passed into the method
	 * @return the double value of the average of all ints in the array
	 */
